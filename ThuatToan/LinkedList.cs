...
//        public Node paritionLast(Node start, Node end, Canvas canvas1)
//        {
...
//        public void Quick_sort(SinglyLinkedList singlyList, Node start, Node end, Canvas canvas1)
//        {
//            if (start == end)
//                return;

//            Node pivot_prev = paritionLast(start, end, canvas1);
//            Quick_sort(singlyList, start, pivot_prev, canvas1);

//            if (pivot_prev != null && pivot_prev == start)
//            {
//                Quick_sort(singlyList, pivot_prev.next, end, canvas1);
//            }


//            else if (pivot_prev != null && pivot_prev.next != null)
//            {
//                Quick_sort(singlyList, pivot_prev.next.next, end, canvas1);
//            }
